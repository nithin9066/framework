...
<div class="py-5">
    ...
    <div class="grid grid-cols-3 gap-2 py-5">
        <div class="p-5 col-span-2 rounded-xl" style="background: #FBD8D8">
            <div class="pb-2">
                <h6 class="mb-2 font-bold text-black">Batch Information</h6>
                <small>Summery</small>
            </div>
            <div class="grid grid-cols-4 gap-2 rounded-xl">
                <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700 space-y-2" style="background: #FFE2E5;">
                    ...
                    <p class="font-semibold text-slate-700 dark:text-navy-100 text-anywhere">
                        Batch Number
                    </p>
                    <p class="mt-1 text-xs+ text-anywhere">OPV-B12345</p>
                </div>
                <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700 space-y-2" style="background: #FFF4DE;">
                    <div class="flex justify-between flex-col space-x-1">
                        <div>
                            <svg width="30" height="30" viewBox="0 0 40 40" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p class="mt-1 text-xs+ text-anywhere">Injectable Concentrate for Infusion</p>
                </div>
                <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700 space-y-2" style="background: #DCFCE7;">
                    <div class="flex justify-between flex-col space-x-1">
                        <div>
                            <svg width="30" height="30" viewBox="0 0 40 40" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p class="mt-1 text-xs+ text-anywhere">10mg/mL (Available in 40mg, 100mg, 120mg, 240mg Vials)</p>
                </div>
                <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700 space-y-2" style="background: #F3E8FF;">
                    <div class="flex justify-between flex-col space-x-1">
                        <div>
                            <svg width="30" height="30" viewBox="0 0 40 40" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p class="mt-1 text-xs+ text-anywhere">Available in 4ml, 10ml, 12ml, 24ml Vials</p>
                </div>
                <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700 space-y-2" style="background: #F3E8FF;">
                    <div class="flex justify-between flex-col space-x-1">
                        <div>
                    ...
                    <p class="mt-1 text-xs+ text-anywhere">31/12/2024</p>
                </div>
            </div>
        </div>
        <div class="p-5 rounded-xl" style="background: #CFF8E7">
            <div class="pb-2">
                <h6 class="mb-2 font-bold text-black">Packaging Information</h6>
                <small>Summery</small>
            </div>
            <div class="grid grid-cols-2 gap-2 rounded-xl">
                <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700 space-y-2" style="background: #FFE2E5;">
                    ...
                    <p class="mt-1 text-xs+ text-anywhere">5000</p>
                </div>
                <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700 space-y-2" style="background: #FFF4DE;">
                    <div class="flex justify-between flex-col space-x-1">
                        <div>
                    ...
                    <p class="mt-1 text-xs+ text-anywhere">1000</p>
                </div>
                <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700 space-y-2" style="background: #DCFCE7;">
                    <div class="flex justify-between flex-col space-x-1">
                        <div>
                    ...
                    <p class="mt-1 text-xs+ text-anywhere">United States</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="p-5 rounded-xl" style="background: #CFF8E7">
        <div class="pb-2">
            <h6 class="mb-2 font-bold text-black">Material Information</h6>
        </div>
        <div class="grid grid-cols-3 gap-4">
            <div style="background: #FFE2E5;" class="p-3 rounded-xl">Packaged Material Name : <span
                    class="text-primary">Opdivo (Nivolumab)</span></div>
            <div style="background: #FFE2E5;" class="p-3 rounded-xl">Packaged Material Number : <span
                    class="text-primary">OPV1234</span></div>
            <div style="background: #FFE2E5;" class="p-3 rounded-xl">Assembled Material Name : <span
                    class="text-primary">Opdivo Concentrate for Infusion</span></div>
            <div style="background: #FFE2E5;" class="p-3 rounded-xl">Assembled Material Number : <span
                    class="text-primary">OPVASB5678</span></div>
            <div style="background: #FFE2E5;" class="p-3 rounded-xl">Assembly Batch Number : <span
                    class="text-primary">OPVASB-B2345</span></div>
            <div style="background: #FFE2E5;" class="p-3 rounded-xl">Filling Batch Number : <span
                    class="text-primary">OPVFILL-B3456</span></div>
            <div style="background: #FFE2E5;" class="p-3 rounded-xl">Filling Material Name : <span
                    class="text-primary">Nivolumab Active Substance and Other Ingredients</span></div>
            <div style="background: #FFE2E5;" class="p-3 rounded-xl">Filling Material Number : <span
                    class="text-primary">OPVFILL1234</span></div>
        </div>
    </div>
    <div class="flex mt-5 h-20 w-full items-center justify-center rounded-lg bg-slate-200 dark:bg-navy-500">
    ...
    <div class="grid grid-cols-2 gap-4 mt-5">
        <div class="ax-transparent-gridline ax-rounded-b-lg bg-white p-5 rounded-xl">
            ...
            <div class="grid grid-cols-2 gap-4 mt-3">
                <div class="grid grid-cols-3 gap-4">
                    <div class="flex justify-end">
                        <svg width="38" height="14" viewBox="0 0 38 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ellipse cx="19.2142" cy="7.19228" rx="7.92857" ry="6.57692" fill="#0095FF" />
                        </svg>
                    </div>
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div class="flex justify-end">
                        <svg width="38" height="14" viewBox="0 0 38 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.42822 6.73077H35.9044" stroke="#05C283" stroke-width="3"
                                stroke-linecap="round" />
                            <ellipse cx="19.1664" cy="6.73073" rx="7.92857" ry="6.57692" fill="#07E098" />
                        </svg>
        ...
        <div class="p-5 rounded-xl" style="background: #CFF8E7">
            <div class="pb-5">
                <h6 class="mb-2 font-bold">Quality Control Testing</h6>
            </div>
            <div class="grid gap-4">
                <div style="background: #FFE2E5;" class="px-5 py-12 rounded-xl">Appearance : <span
                        class="text-primary">White crystalline powder (Compliant)</span></div>
                <div style="background: #FFE2E5;" class="px-5 py-12 rounded-xl">Dissolution : <span
                        class="text-primary">98% (Compliant)</span></div>

            </div>
        </div>

        <div class="p-5 rounded-xl" style="background: #CDD6F4">
            <div class="pb-5">
                <h6 class="mb-2 font-bold text-black">Cold Chain Monitoring</h6>
            </div>
            <div class="space-y-3">
                <div class="grid grid-cols-5 gap-4">
                    ...
                    <div class="col-span-2">
                        <div class="progress mt-3 h-1.5 bg-slate-150 dark:bg-navy-500">
                            <div style="width: 5%;" class="is-active relative overflow-hidden rounded-full bg-primary">
                            </div>
                        </div>
                    </div>
                    <div class="">
                        <div class="w-full badge px-0 bg-primary/10 text-primary dark:bg-primary/15">
                            2°C%
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-5 gap-4">
                    ...
                    <div class="col-span-2">
                        <div class="progress mt-3 h-1.5 bg-slate-150 dark:bg-navy-500">
                            <div style="width: 8%;" class="is-active relative overflow-hidden rounded-full bg-success">
                            </div>
                        </div>
                    </div>
                    <div class="">
                        <div class="w-full badge px-0 bg-success/10 text-success dark:bg-success/15">
                            8°C%
                        </div>
                    </div>
                </div>
                <div class="grid grid-cols-5 gap-4">
                    ...
                    <div class="col-span-2">
                        <div class="progress mt-3 h-1.5 bg-slate-150 dark:bg-navy-500">
                            <div style="width: 20%;" class="is-active relative overflow-hidden rounded-full bg-warning">
                            </div>
                        </div>
                    </div>
                    <div class="">
                        <div class="w-full badge px-0 bg-warning/10 text-warning dark:bg-warning/15">
                            72 hr
                        </div>
                    </div>
                </div>
                <div class="grid grid-cols-5 gap-4">
                    ...
                    <div class="col-span-2">
                        <div class="progress mt-3 h-1.5 bg-slate-150 dark:bg-navy-500">
                            <div style="width: 80%;" class="is-active relative overflow-hidden rounded-full bg-black">
                            </div>
                        </div>
                    </div>
                    <div class="">
                        <div class="w-full badge px-0 bg-black/10 text-black dark:bg-black/15">
                            2 hr 5 min
                        </div>
                    </div>
                </div>
                <div class="grid grid-cols-5 gap-4">
                    ...
                    <div class="col-span-2">
                        <div class="progress mt-3 h-1.5 bg-slate-150 dark:bg-navy-500">
                            <div style="width: 80%;"
                                class="is-active relative overflow-hidden rounded-full bg-[#B22234]"></div>
                        </div>
                    </div>
                    <div class="">
                        <div class="w-full badge px-0 bg-[#B22234]/10 text-[#B22234] dark:bg-[#B22234]/15">
                            12 hr
                        </div>
                    </div>
                </div>
        ...
        <div>
            <div class="p-5 rounded-xl" style="background: #F9ECEC">
                <div class="pb-5">
                    <h6 class="mb-2 font-bold text-black">Temperature Data Analysis</h6>
                </div>
                <div class="space-y-3">
                    <div class="grid grid-cols-5 gap-4">
                        <div class="col-span-2">
                        ...
                        <div class="col-span-2">
                            <div class="progress mt-3 h-1.5 bg-slate-150 dark:bg-navy-500">
                                <div style="width: 5%;"
                                    class="is-active relative overflow-hidden rounded-full bg-[#0095FF]"></div>
                            </div>
                        </div>
                        <div class="">
                            <div class="w-full badge px-0 bg-[#0095FF]/10 text-[#0095FF] dark:bg-[#0095FF]/15">
                                4.5°C
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-5 gap-4">
                        ...
                        <div class="col-span-2">
                            <div class="progress mt-3 h-1.5 bg-slate-150 dark:bg-navy-500">
                                <div style="width: 8%;"
                                    class="is-active relative overflow-hidden rounded-full bg-[#00E096]"></div>
                            </div>
                        </div>
                        <div class="">
                            <div class="w-full badge px-0 bg-[#00E096]/10 text-[#00E096] dark:bg-[#00E096]/15">
                                0
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-[#75F6CB] px-4 py-3 rounded-lg mt-5">
    ...
    <div class="grid grid-cols-2 gap-4 mt-5">
        <div class="ax-transparent-gridline ax-rounded-b-lg bg-[#E9DADA] p-5 rounded-xl">
            <h3 class="text-sm font-medium tracking-wide text-black line-clamp-1 dark:text-navy-100">
            ...
            <div class="grid grid-cols-2 gap-4 mt-3">
                <div class="grid grid-cols-5 gap-4">
                    <div class="flex justify-end">
                        <svg width="19" height="17" viewBox="0 0 19 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="0.280273" y="0.687729" width="18.0593" height="15.3295" rx="6" fill="#0095FF"/>
                            </svg>                            
                    </div>
                ...
                <div class="grid grid-cols-5 gap-4">
                    <div class="flex justify-end">
                        <svg width="19" height="17" viewBox="0 0 19 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0.409668 6.68758C0.409668 3.37387 3.09596 0.687576 6.40967 0.687576H12.469C15.7827 0.687576 18.469 3.37387 18.469 6.68758V10.0171C18.469 13.3308 15.7827 16.0171 12.469 16.0171H6.40967C3.09596 16.0171 0.409668 13.3308 0.409668 10.0171V6.68758Z" fill="#00E096"/>
                            </svg>
                    </div>
                    <div class="flex flex-col col-span-4">
        ...
        <div class="p-5 rounded-xl" style="background: #C9BE8C">
            <div class="pb-5">
                <h6 class="mb-2 font-bold text-black">Quality Control Testing</h6>
            </div>
            <div class="grid gap-4">
                <div style="background: #FFE2E5;" class="p-5 rounded-xl">pH : <span class="text-primary"></span></div>
                <div style="background: #FFE2E5;" class="p-5 rounded-xl">Chemical Oxygen Demand (COD) : <span class="text-primary">20 mg/L</span></div>
                <div style="background: #FFE2E5;" class="p-5 rounded-xl">Biochemical Oxygen Demand (BOD) : <span class="text-primary">20 mg/L</span></div>
            </div>
        </div>
        <div class="p-5 rounded-xl col-span-2" style="background: #F3DD81">
            <div class="pb-5">
                <h6 class="mb-2 font-bold text-black">Waste Management</h6>
            </div>
            <div class="space-y-5">
                <div style="background: #FFE2E5;" class="p-5 rounded-xl grid grid-cols-5"><span class="col-span-2">Hazardous Waste Disposal</span><span>:</span> <span class="text-primary col-span-2">As per BMS protocol</span></div>
                <div style="background: #FFE2E5;" class="p-5 rounded-xl grid grid-cols-5"><span class="col-span-2">Non-hazardous Waste Disposal</span> <span>:</span><span class="text-primary col-span-2">As per BMS protocol</span></div>
                <div style="background: #FFE2E5;" class="p-5 rounded-xl grid grid-cols-5"><span class="col-span-2">Recycling Program</span> <span>:</span><span class="text-success col-span-2">Active</span></div>
            </div>
        </div>
    </div>
    <div class="flex mt-5 h-20 w-full items-center justify-center rounded-lg bg-slate-200 dark:bg-navy-500">
    ...
    <div class="grid grid-cols-5 gap-5 mt-5 bg-slate-200 p-5 rounded-xl text-black font-bold">
        ...
        <div class="col-span-4">
            I hereby certify that the batch has been manufactured, tested, and released in compliance with all applicable regulations and guidelines.
        </div>
        <div>
